...
var rallax = createCommonjsModule(function (module, exports) {
  !function (t, e) {
     module.exports = e() ;
    ...
    var t = function () {
      ...
      return t(o, [{
        ...
        key: "changeSpeed",
        value: function (t) {
          this.inWindow() && t !== this.speed && (this.accumulated = this.getTranslation(), this.startScroll = this.scrollY()), this.speed = t;
        }
      }, {
        key: "when",
        value: function (t, e) {
        ...
        key: "getTranslation",
        value: function () {
          var t = (this.scrollY() - this.startScroll) * this.speed + this.accumulated;
          return 0 <= t ? t : 0;
        }
      }, {
        key: "getRect",
        value: function () {
          return this.targetR = this.target.getBoundingClientRect(), this.targetR;
        }
      }, {
        key: "inWindow",
        value: function () {
          this.getRect();
          var t = this.targetR.top,
              e = this.targetR.bottom;
          return t < this.winHeight && 0 < e;
        }
      }, {
        key: "move",
        value: function () {
      ...
      requestAnimationFrame(function () {
        t.forEach(function (t) {
          t.mobileDisable || (t.conditions.forEach(function (t) {
            var e = t.condition,
                i = t.action;
            e() && i();
          }), t.active && t.move());
      ...
      o.forEach(function (t) {
        t.mobilePx >= e && (t.mobileDisable = !0);
      });
    };
    ...
    return function (t) {
      var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          i = new a(t, e);
      return o.push(i), u(), n || (window.addEventListener("scroll", function (t) {
        c(o);
...
class _event {
  ...
  off(evt, callback, scope) {
    ...
    let _off = function ($evt, callback, scope) {
      ...
      if (callback) {
        ...
        for (; i < _Evt.length; i++) {
          ...
          if (val.callback === app.callback && val.scope === app.scope) {
            break;
          }
        }
    ...
    keys(evt).forEach(function (key) {
      ...
      if (_is.obj(evt) && !_is.obj(evt)) {
        ...
        _off.call(this, $evt, callback, scope);
      }
    }, this);
    return this;
  ...
  emit(evt, args, scope) {
    ...
    evt.forEach(function ($evt) {
      ...
      $Evt.forEach(_evt => {
        $args = args; // Check to see if first param is $evt, if so give details about event
...
let _elem = (sel, ctxt) => {
  if (_is.str(sel)) {
    ...
    new ele(document).on("ready", sel);
  }

  return [];
}; // Element Object [Based on Zepto.js]

var ele$1 = ele = class extends _event {
  ...
  on(evt, opts, callback) {
    let _newEvts,
        _evt,
        delegate,
        $super = _event.prototype.on.bind(this);
    ...
    [].forEach.call(this, (el, i) => {
      ...
      let _emit = evt => e => {
        ...
        if (!_is.str(delegate) || _matches(e.target, delegate)) this.emit(evt, [e, target, this, i], target);
      };
      ...
      if (/ready/.test(_newEvts)) {
        ...
        _newEvts.forEach(val => {
          ...
          el.addEventListener(val, _emit(val), val === "scroll" ? passive : {
            useCapture
          });
        });
      }
...
let {
  ...
  onhover: (_el, fnOver, fnOut) => el(_el).on("mouseenter", fnOver).on("mouseleave", fnOut || fnOver)
});
...
let _focusPt = _height + 10; // el(_navbar).on("click touchstart", '.navbar-menu', e => {
//     e.preventDefault();
...
each('.load-img', ($el, i) => {
  ...
  images[i].when(() => images[i].inWindow(), () => images[i].start());
  images[i].when(() => !images[i].inWindow(), () => images[i].stop());
}); // new Rellax('.load-img', {
